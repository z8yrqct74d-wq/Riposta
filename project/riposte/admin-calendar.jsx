// ============================================================
// RIPOSTE — Admin · Resource calendar (HERO FLOW)
// Lanes = pistes, blocks draggable/resizable, conflict detection,
// invalid-drop shake, side panel create/edit.
// ============================================================

const snap = (v) => Math.round(v / SNAP) * SNAP;
const overlap = (aS, aD, bS, bD) => aS < bS + bD && bS < aS + aD;

function findConflicts(cand, blocks) {
...
function ResourceCalendar({ blocks, setBlocks, onSelect, onCreate, toast }) {
  const gridRef = React.useRef(null);
  const [drag, setDrag] = React.useState(null);     // {id,mode,startX,startY,orig...}
  ...
  // blocks to render — substitute live drag candidate
...
Object.assign(window, { ResourceCalendar, findConflicts, snap });
