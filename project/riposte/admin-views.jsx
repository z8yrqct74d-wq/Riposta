// ============================================================
// RIPOSTE — Admin · Dashboard (A1) + Members (A2)
// ============================================================
...
function CardLabel({ children, accent }) {
  return <div style={{ fontSize: 12, fontWeight: 600, textTransform: 'uppercase', letterSpacing: '0.05em', color: accent || 'var(--faint)', marginBottom: 12 }}>{children}</div>;
}

function AdminDashboard({ onGotoCalendar, onGotoMembers }) {
  const timeline = [
...
const PAY_BAR = { paid: 'var(--success)', due: 'var(--warning)', overdue: 'var(--danger)', refunded: 'var(--hairline)' };

function AdminMembers({ onSelectMember }) {
...
Object.assign(window, { AdminDashboard, AdminMembers, StatCard, CardLabel, MEMBERS, PAY_BAR });
