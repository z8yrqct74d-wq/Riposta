// ============================================================
// RIPOSTE — Admin · A3 Member detail
// Tabs: Overview · Attendance · Payments · Notes · Compliance
// ============================================================
        ...
        <>
          ...
          <div style={{ position: 'absolute', top: 0, right: 0, bottom: 0, width: 320, background: 'var(--surface)', borderLeft: '1px solid var(--hairline)', zIndex: 50, display: 'flex', flexDirection: 'column', animation: 'r-panel 240ms var(--e-enter)', boxShadow: 'var(--shadow-raise)' }}>
            ...
            <div style={{ flex: 1, padding: 20, display: 'flex', flexDirection: 'column', gap: 16 }}>
              ...
              {[['Type', <select style={{ width: '100%', padding: '9px 11px', border: '1px solid var(--hairline)', borderRadius: 'var(--r-btn)', background: 'var(--paper)', font: 'inherit', fontSize: 13.5, color: 'var(--ink)' }}><option>Manual payment</option><option>Credit top-up</option><option>Refund</option></select>], ['Amount', <input type="number" defaultValue="120" style={{ width: '100%', padding: '9px 11px', border: '1px solid var(--hairline)', borderRadius: 'var(--r-btn)', background: 'var(--paper)', font: 'inherit', fontSize: 13.5, color: 'var(--ink)', boxSizing: 'border-box' }} />], ['Note', <input placeholder="e.g. Cash payment for June" style={{ width: '100%', padding: '9px 11px', border: '1px solid var(--hairline)', borderRadius: 'var(--r-btn)', background: 'var(--paper)', font: 'inherit', fontSize: 13.5, color: 'var(--ink)', boxSizing: 'border-box' }} />]].map(([label, field]) => (
...
Object.assign(window, { MemberDetail, MEMBER_DETAIL });
